...
class BadgeAcceptanceManager:
    ...
    def __init__(self, recipient_nsec: str):
        ...
        # Backup directory will be created relative to the calling script's directory
        # For badge_inbox, this will be badge_inbox/badge_backups/
        caller_file = inspect.stack()[1].filename
        caller_dir = Path(caller_file).parent
        self.backup_dir = caller_dir / "badge_backups"
